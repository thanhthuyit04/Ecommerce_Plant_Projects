...
import logo from "../../Assets/greengarden.png";
import "./Footer.css";
    ...
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        ...
        <div className="location flex py__10">
          ...
          <h6>411, Nguyen Thi Thanh Thuy</h6>
        </div>
      ...
      <div className="mobile">
        <div className="footer__2nd__part">
             ...
             <Link to="/Products"><h3>Plants</h3></Link>
        ...
        <div className="footer__2nd__part">
             <h5>Follow us</h5>
             <Link to="/facebook.com"><h3><BsFacebook /> Facebook</h3></Link>
             <Link to="/youtube.com"><h3><BsFacebook /> Youtube</h3></Link>
             <Link to="/instagram.com"><h3><BsFacebook /> Instagram</h3></Link>
        </div>
      {/* Footer 4th part */}
       <div className="footer__3rd__part">
            <h5>Service</h5>
             <Link to="/"><h3>Hỗ trợ</h3></Link>
             <Link to="/"><h3>Chăm sóc khách hàng</h3></Link>
             <Link to="/"><h3>Thông tin vẫn chuyển</h3></Link>
             <Link to="/"><h3>Chính sách đặt hàng</h3></Link>
             <Link to="/"><h3>Điều khoản và điều kiện</h3></Link>
       </div>
      </div>
    </div>
  );
