    ...
    <div className="Header__topbar space__between">
      ...
      >
        <div className="inputBox" >
          ...
          >
            Welcome to my shop...You can find plants in here as your
            favorites..
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          <strong style={{
            padding:"0px 5px"
          }}>Email:</strong> thuy4111909@gmail.com
        </span>
      </div>
    </div>
    {/* Header Navbar */}
    <div className="navbar flex pz__10 space__between" ref={switcherTab}>
      ...
      <div
       className="navigation flex align__items__center"
       style={{
         padding:"0px 50px"
       }}
      >
